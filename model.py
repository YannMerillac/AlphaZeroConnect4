...
class Connect4Model(nn.Module):
    ...
    def __init__(self, board_size, action_size, device, hidden_size=64):
        ...
        self.fc1 = nn.Linear(in_features=self.size, out_features=hidden_size)
        self.fc2 = nn.Linear(in_features=hidden_size, out_features=hidden_size)

        # Two heads on our network
        self.action_head = nn.Linear(in_features=hidden_size, out_features=self.action_size)
